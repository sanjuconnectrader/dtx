...
function GrowthChartIcon() {
  return (
    <svg width="55" height="55" viewBox="0 0 55 55" fill="none" className="flex-shrink-0">
...
function ShieldIcon() {
  return (
    <svg width="45" height="55" viewBox="0 0 45 55" fill="none" className="flex-shrink-0">
...
function BrandIcon() {
  return (
    <svg width="60" height="60" viewBox="0 0 70 70" fill="none" className="flex-shrink-0">
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 mx-auto grid min-h-screen w-full max-w-[1600px] grid-cols-1 items-center px-6 py-20 lg:grid-cols-[minmax(0,720px)_minmax(0,575px)] lg:gap-[70px] lg:px-[70px] xl:grid-cols-[760px_575px] xl:gap-[80px] xl:px-[70px]">
          {/* Left Content */}
          <div>
            <p className="mb-[38px] text-[18px] font-extrabold uppercase leading-none tracking-[-0.2px] text-[#D4A33C]">
              SMARTER OUTREACH • FASTER SALES • BIGGER GROWTH
            </p>

            <h1 className="text-[48px] font-black uppercase leading-[1.15] tracking-[-2px] sm:text-[58px] lg:text-[60px]">
            ...
            <p className="mt-[34px] max-w-[640px] text-[19px] leading-[1.75] text-white">
            ...
            <div className="mt-[28px] space-y-[24px]">
              {points.map((item) => (
                <div key={item} className="flex items-center gap-[28px]">
                  <CheckIcon />
            ...
            <div className="mt-[34px] flex flex-wrap gap-[26px]">
              <Link
                href="/contact"
                className="flex h-[61px] min-w-[224px] items-center justify-center rounded-[10px] bg-[#D4A33C] px-7 text-[18px] font-black uppercase text-black transition hover:opacity-90"
              >
                SCALE MY BRAND
              </Link>
              ...
              <Link
                href="/results"
                className="flex h-[61px] min-w-[205px] items-center justify-center rounded-[10px] border border-white/80 bg-black/10 px-7 text-[18px] font-black uppercase text-white transition hover:bg-white/10"
              >
                SEE THE PROOF
              </Link>
            </div>
          ...
          {/* Form Card */}
          <div className="w-full max-w-[575px] justify-self-end rounded-[26px] border border-white/25 bg-white/10 px-[48px] py-[44px] shadow-2xl backdrop-blur-md">
            <h2 className="mb-[39px] text-[38px] font-extrabold leading-none tracking-[-1px]">
              Start Your <span className="text-[#D4A33C]">Growth</span> Audit
            </h2>

            <form className="space-y-[29px]">
              {["First Name", "Last Name", "Phone Number", "Email"].map(
                (placeholder) => (
                  <input
                    ...
                    className="h-[56px] w-full rounded-[8px] border border-white/30 bg-[#666666] px-[27px] text-[18px] font-medium text-white outline-none placeholder:text-white"
                  />
                )
              )}
              ...
              <textarea
                ...
                className="h-[91px] w-full resize-none rounded-[8px] border border-white/30 bg-[#666666] px-[27px] py-[15px] text-[18px] font-medium text-white outline-none placeholder:text-white"
              />

              <button
                type="submit"
                className="flex h-[60px] min-w-[196px] items-center justify-center rounded-[10px] bg-[#D4A33C] px-7 text-[17px] font-black uppercase text-black transition hover:opacity-90"
              >
                BOOK THE WIN
              </button>
            </form>
      ...
      <section className="bg-white px-4 py-12 text-black sm:px-6 sm:py-16 lg:px-12 lg:py-20 xl:px-20">
        <div className="mx-auto max-w-[1420px]">
          {/* Header */}
          <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <span className="text-xs font-semibold uppercase tracking-widest text-[#C79A3A] sm:text-sm">
                Why DTX
              </span>
              ...
              <p className="mt-2 max-w-lg text-sm text-gray-600 sm:mt-4 sm:text-base">
                We partner with ambitious businesses that demand growth, speed,
                and measurable results.
              </p>
            </div>

            <div className="flex items-center gap-6 text-gray-400 sm:gap-8 lg:gap-12">
              <span className="text-lg font-bold tracking-widest sm:text-xl lg:text-2xl">
                SONY
              </span>
              <span className="text-lg font-semibold sm:text-xl lg:text-2xl">Google</span>
              <span className="text-lg font-bold tracking-widest sm:text-xl lg:text-2xl">
                IBM
              </span>
            </div>
          ...
          {/* Features Grid */}
          <div className="mt-8 sm:mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className={`group rounded-2xl border border-gray-100 bg-gray-50/50 p-5 transition-all hover:border-[#C79A3A]/30 hover:bg-[#f5efe3] hover:shadow-lg sm:p-6 ${
              ...
              >
                ...
                <h3 className="mt-2 text-base font-bold sm:mt-4 sm:text-lg">{feature.title}</h3>
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20 grid items-center gap-8 sm:gap-12 lg:grid-cols-[1fr_1fr]">
            <div className="relative order-2 h-[250px] overflow-hidden rounded-2xl sm:h-[350px] lg:order-1 lg:h-[480px]">
              <Image
                src={home2}
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="mt-4 sm:mt-8 space-y-3 sm:space-y-4 text-sm leading-relaxed text-gray-600 sm:text-base">
              ...
              <button className="mt-6 sm:mt-8 rounded-lg bg-[#C79A3A] px-6 py-2.5 text-xs font-bold uppercase tracking-wide text-black transition-all hover:bg-[#D4A33C] hover:scale-105 sm:px-8 sm:py-3.5 sm:text-sm">
      ...
      <section className="bg-[#F8F5F0] px-4 py-16 text-black sm:px-6 sm:py-20 lg:px-12 lg:py-24 xl:px-20">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="mt-3 text-3xl font-black leading-tight tracking-[-0.5px] sm:text-4xl md:text-5xl lg:text-[48px] whitespace-nowrap">
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-8">
            {intelligentCards.map((card) => (
              <div
                key={card.title}
                className="group relative rounded-2xl bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border border-gray-100/80 hover:border-[#C79A3A]/30"
              >
                {/* Decorative top line */}
                ...
                {/* Icon */}
                <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-[#F8F5F0] transition-colors group-hover:bg-[#C79A3A]/10">
                  {card.icon}
                </div>

                {/* Title */}
                <h3 className="mt-5 text-lg font-black leading-tight tracking-[-0.3px] sm:text-xl">
                  {card.title}
                </h3>

                {/* Mission */}
                <div className="mt-4">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#C79A3A]">
                    The Mission
                  </span>
          ...
          <div className="mt-12 text-center sm:mt-16">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
              <Link
                href="/contact"
                className="flex h-[52px] min-w-[220px] items-center justify-center rounded-lg bg-[#C79A3A] px-8 text-sm font-black uppercase tracking-wide text-black transition-all hover:bg-[#D4A33C] hover:scale-105 sm:h-[56px] sm:min-w-[240px] sm:text-base"
              >
                Claim The Advantage
              </Link>
              ...
              <Link
                href="/contact"
                className="flex h-[52px] min-w-[220px] items-center justify-center rounded-lg border-2 border-black bg-transparent px-8 text-sm font-black uppercase tracking-wide text-black transition-all hover:bg-black hover:text-white sm:h-[56px] sm:min-w-[240px] sm:text-base"
              >
      ...
      <section className="bg-white px-4 py-16 text-black sm:px-6 sm:py-20 lg:px-12 lg:py-24 xl:px-20">
        <div className="mx-auto max-w-[1440px]">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
            ...
            <div>
              ...
              {/* Heading */}
              <h2 className="mt-3 text-3xl font-black leading-[1.2] tracking-[-0.5px] sm:text-4xl lg:text-[42px]">
              ...
              <div className="mt-8 space-y-0 divide-y divide-gray-100">
                {speedFeatures.map((item) => (
                  ...
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#C79A3A]/10">
                      <FeatureIcon type={item.icon} />
                    </div>

                    <p className="text-sm font-medium leading-relaxed text-gray-700 sm:text-base lg:text-[17px]">
                      {item.text}
                    </p>
                  </div>
                ))}
              ...
              <Link
                href="/contact"
                className="mt-10 inline-flex h-[52px] w-full items-center justify-center rounded-lg bg-[#C79A3A] px-8 text-sm font-black uppercase tracking-wide text-black transition-all hover:bg-[#D4A33C] hover:scale-[1.02] sm:w-auto sm:min-w-[280px] sm:text-base"
              >
            ...
            {/* Right Image */}
            <div className="relative h-[300px] overflow-hidden rounded-2xl sm:h-[400px] lg:h-[520px]">
              <Image
                src={home3}
